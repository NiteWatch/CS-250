...
bool Tester::TestSubscriptOperator()
{
	bool allTestsPass = true;
...
bool Tester::TestEqualityOperator()
{
	bool allTestsPass = true;
...
void Tester::ReportFailure(const string& test, const string& message)
{
